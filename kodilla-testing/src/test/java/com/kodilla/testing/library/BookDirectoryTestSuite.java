...
public class BookDirectoryTestSuite {
    ...
    @Test
    void testListBooksInHandsOfWhenNoBookIsBorrowed() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("Test", "Test", "12345");
    ...
    @Test
    void testListBooksInHandsOfWhen1BookIsBorrowed() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("Test", "Test", "12345");
    ...
    @Test
    void testListBooksInHandsOfWhen5BookIsBorrowed() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("Test", "Test", "12345");
