...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://agachalat85.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kontakt@akramarz.de");
        driverTrello.findElement(By.id("password")).sendKeys("Aga8509#!?");
